...
function openTool(toolId) {
  ...
  const tools = {
    ...
    fibonacci: { title: 'Calculadora de Fibonacci', render: renderFibonacci },
    marginCalc: { title: 'Calculadora de Margen', render: renderMarginCalc },
    drawdown: { title: 'Simulador de Drawdown', render: renderDrawdown },
    sessions: { title: 'Sesiones de Mercado', render: renderSessionsClock },
    candleQuiz: { title: 'Quiz de Patrones de Velas', render: renderCandleQuiz }
  };
